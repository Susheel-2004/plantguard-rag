...
"""
NEW_PROMPT_TEMPLATE = """
Provide a clear and concise answer to the question below based on the context related to plants only. Do not include any phrases that indicate the source of the information. if you can't answer the question, say you don't know and urge them to ask questions related to the context.
